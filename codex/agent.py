"""
Agent — the core reasoning loop that drives CodeX.
...
from codex.models.tokenizer import count_tokens
from codex.tools.base import ToolRegistry, get_registry
from codex.types import Message, Role, ToolCall, ToolResult, Turn
    ...
    def _filter_through_gate(
        ...
        for tc in tool_calls:
            ...
            if gate_result.decision == GateDecision.BLOCK:
                ...
                # In a real system, this would trigger user approval
